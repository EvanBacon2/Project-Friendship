...
public class RECSRigidbody : MonoBehaviour {
    ...
    protected ManagedRequestableWrapper<Vector3> _position;
    public ManagedRequestableWrapper<Quaternion> _rotation;
    private ManagedRequestableWrapper<Vector3> _velocity;
    private ManagedRequestableWrapper<Vector3> _angularVelocity;
    private ManagedRequestableWrapper<List<(Vector3, ForceMode)>> _force;
    private ManagedRequestableWrapper<List<(Vector3, ForceMode)>> _torque;
    ...
    void Start() {
        ...
        PoolManager<Vector3> positionPool = new();
        _position = new ManagedRequestableWrapper<Vector3>(
        ...
        PoolManager<Quaternion> rotationPool = new();
        _rotation = new ManagedRequestableWrapper<Quaternion>(
        ...
        PoolManager<Vector3> velocityPool = new();
        _velocity = new ManagedRequestableWrapper<Vector3>(
        ...
        PoolManager<Vector3> angularVelocityPool = new();
        _angularVelocity = new ManagedRequestableWrapper<Vector3>(
        ...
        PoolManager<List<(Vector3, ForceMode)>> forcePool = new();
        _force = new ManagedRequestableWrapper<List<(Vector3, ForceMode)>>(
        ...
        PoolManager<List<(Vector3, ForceMode)>> torquePool = new();
        _torque = new ManagedRequestableWrapper<List<(Vector3, ForceMode)>>(
            () => { return new List<(Vector3, ForceMode)>(); },
